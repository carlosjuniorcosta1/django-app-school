...
from .views.post_views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, ChapterCreateView
...
from .views.linguistics_views import ListCorpus
...
urlpatterns = [
    ...
    path('create_post_main/<int:post_id>/chapter/', ChapterCreateView.as_view(), name="create_chapter"),
    ...
    path('list_corpus', ListCorpus.as_view(), name='list_corpus'),

...
from .views.enem_language_quiz_view import EnemLanguagesQuizListView
...
urlpatterns = [
        ...
        path('list/questions/language', EnemLanguagesQuizListView.as_view(), name="enem-language-quiz" ),
